...
class OfferTargetsControllerTest < ActionDispatch::IntegrationTest
  ...
  # test "should create offer_target" do
  #   assert_difference("OfferTarget.count") do
  #     post offer_targets_url, params: {
  #       offer_target: {
  ...
  #   end
  #
  #   assert_redirected_to offer_target_url(OfferTarget.last)
  # end
