class DevicesController < ApplicationController
  ...
  # curl -X PATCH localhost:3000/devices/1.json -H "Accept: application/json" -d 'device[model]=foobar'
  # curl http://localhost:3000/devices/1.json
  ...
  # curl -X DELETE localhost:3000/devices/1.json
